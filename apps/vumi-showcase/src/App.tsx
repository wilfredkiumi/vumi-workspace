...
import { Palette, Image, Layers, Award, Users, Zap, Heart, Star } from 'lucide-react';
                ...
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg shadow-2xl">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/20 p-4 rounded-lg">
                      ...
                      <h3 className="text-white font-medium">Beautiful Portfolios</h3>
                    </div>
                    <div className="bg-white/20 p-4 rounded-lg">
                    ...
                    <div className="bg-white/20 p-4 rounded-lg">
                      ...
                      <h3 className="text-white font-medium">Get Discovered</h3>
                    </div>
                    <div className="bg-white/20 p-4 rounded-lg">
